...
define('_AM_XLANGUAGE_EDITLANG', 'Edit language');
define('_AM_XLANGUAGE_ADDLANG', 'Add language');
define('_AM_XLANGUAGE_CREATED', 'The config file has been created');
define('_AM_XLANGUAGE_CONFIGOK', 'Config file is availabe');
define('_AM_XLANGUAGE_CONFIGNOTOK', 'Config file is not availabe');
define('_AM_XLANGUAGE_ADDBASE', 'Add base language');
